...
//  DHFramework
//
//  Created by daixinhui on 16/4/19.
...
/**
 * Returns a new array containing the dictionary's keys sorted. The keys should be NSString, and they will be sorted ascending.
 ...
 * @return A new array containing the dictionary's values sorted by keys, or an empty array if the dictionary has no entries.
 */
...
/**
 * Returns a new dictionary containing the entries for keys. If the keys is empty or nil, it just returns an empty dictionary.
 * @param keys The keys.
...
/**
 * Try to parse an XML and wrap it into a dictionary. If you just want to get some value from a small xml, try this.
...
- (short)shortValueForKey:(NSString *)key default:(int)def;
...
- (unsigned long long)unsignLongLongValueForKey:(NSString *)key default:(unsigned long long)def;

- (float)floatValueForKey:(NSString *)key default:(float)def;
- (double)doubleValueForKey:(NSString *)key default:(double)def;

- (NSInteger)intergerValueForKey:(NSString *)key default:(NSInteger)def;
- (NSInteger)unsignedIntegerValueForKey:(NSString *)key default:(NSInteger)def;
...
/**
 * Creates and returns a dictionary from a specified property list data.
 * @param plist Aproperty list data whose root object is a dictionary.
 * @return A new dictionary created from the binary plist data, or nil if an error occurs.
 * @discussion Apple has implemented this method, but did not make it public.
 */
...
/**
 * Creates and returns a dictionary from a specified property list xml string.
 * @param plist Aproperty list xml string whose root object is a dictionary.
 * @return A new dictionary created from the plist string, or nil if an error occurs.
 */
...
/**
 * Removes a new dictionary containing the entries for keys, and remove these entries from receiver. If the keys is empty or nil, it just returns an empty dictionary.
 * @param keys The keys.
 * @return The entries for the keys.
 */
