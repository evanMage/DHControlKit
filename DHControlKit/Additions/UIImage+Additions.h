...
///=============================================================================
/**
 Create an animated image with GIF data. After created, you can access the images via property '.images'. If the data is not animated gif, this function is same as [UIImage ImageWithData:data scale:scale];
 ...
 @discussion        It has a better display performance, but costs more memory
                    ...
                    gif such as animated emotiocon.
...
/**
 ...
 @return Returns YES only if the data is gif and contains more than one frame, otherwise returns NO.
 */
