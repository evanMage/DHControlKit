...
/**
 * Provide some method for 'NSNotificationCenter' to post notification in different thread.
 */
@interface NSNotificationCenter (Additions)

/**
 Posts a given notification to the receiver on main thred. If current thread is main thread, the notification is posted synchronously; otherwise, is posted asynchronously.
 @param notification The notification to post. An exception is raised if notification is nil.
 */
...
/**
 ...
 If current thread is main thread, the notification is posted synchronously; otherwise, is posted asynchronously.
 
 @param name        The name of the notification.
 
 @param object      The object posting the notification.
 
 @param userInfo    Information about the notification. My be nil.
 */
- (void)postNotificationOnMainThreadWithName:(NSString *)name
                                      object:(nullable id)object
...
/**
 ...
 @param userInfo    Information about the notification. May be nil.
