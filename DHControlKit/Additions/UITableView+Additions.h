...
/**
 Perform a series of method calls that insert, delete, or select rows and sections of the receiver.
 ...
 @discusson     If you do not make the insertion, deletion, and selection calls
                ...
                animations yourself.
 @param block   Ablock combine a series of method calls.
 */
- (void)updateWithBlock:(void(^)(UITableView *tableView))block;

/**
 Scrolls the receiver nutil a row or section location on the screen.
 ...
 @param row             Row index in section. NSNotFound is Avalid value for scrolling to a section with zero rows.
...
/**
 ...
 @param animation   A constant that indicates how the deletion is to be animated, for example, fade out or slide out from the bottom.
 */
...
/**
 Deletes the row specified by an array of index paths,with an option to animate the deletion.
 
 @param indexPate   An NSIndexPath object representing a row index and section index tha together identify a row in the table view.
 
 @param animation   a constant that indicates how the insertion is to be animated, for example, fade in or slide in from the bottom.
 */
