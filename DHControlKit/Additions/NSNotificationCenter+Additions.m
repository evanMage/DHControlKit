...
- (void)postNotificationOnMainThread:(NSNotification *)notification waitUntilDone:(BOOL)wait
{
    ...
    [[self class] performSelectorOnMainThread:@selector(_DH_postNotification:) withObject:notification waitUntilDone:wait];
}
...
- (void)postNotificationOnMainThreadWithName:(NSString *)name object:(id)object userInfo:(NSDictionary *)userInfo waitUntilDone:(BOOL)wait
{
    ...
    [[self class] performSelectorOnMainThread:@selector(_DH_postNotificationName:) withObject:info waitUntilDone:wait];
}

+ (void)_DH_postNotification:(NSNotification *)notification {
    [[self defaultCenter] postNotification:notification];
}

+ (void)_DH_postNotificationName:(NSDictionary *)info {
