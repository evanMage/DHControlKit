...
//  DHFramework
//
//  Created by daixinhui on 16/4/20.
...
#pragma mark - Sending message with variable parameters
///=============================================================================
...
/**
 ...
 @param ...     Variable parameter list.Parameters type must correspond to the
                ...
                It doesn's support union or struct which is larger than 256 bytes.
 ...
 @discussion    The selector's return value will be wrap as NSNumber or NSValue
                if the selector's 'retrun type' is not object. It always returns nil
...
/**
 Returns the class name in NSString.
 @discussion Apple has implemented this method in NSObject(NSLayoutConstraintCallsThis), but did not make it public.
 */
- (NSString *)className;
...
/**
 Returns a copy of instance use archiver and unarchiver. Returns nil if an error occurs.
 @param archiver NSKeyedArchiver class or any class inherited.
 @param unarchiver NSKeyedUnarchiver class or an class inherited.
 */
